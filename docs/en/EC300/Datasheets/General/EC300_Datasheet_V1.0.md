<div style="width: 100%;height: 100%;background: url(images/EC312.jpg); background-size: 100% 100%;">
  ...
  <div style="padding-left: 40px;">
    <div style="font-size: 40px; font-weight: bold; color:#000; margin-top: 50px; margin-bottom: 30px;">
      EC312 Series Secure Edge Computer
    </div>
    <div style="text-align: center;">
      <div style="display: flex; flex-wrap: wrap; gap: 16px; ">
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">· IEC62443 Certified</div>
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">· Standard Linux OS</div>
      </div>
...
| Operating Temperature | Models with Wi-Fi: -20 °C ~ 70 °C (-4 °F ~ 158 °F) / Models without Wi-Fi: -40 °C ~ 70 °C (-40 °F ~ 158 °F) |
...
## <span style="color: green;">Operating System (Optional)</span>
