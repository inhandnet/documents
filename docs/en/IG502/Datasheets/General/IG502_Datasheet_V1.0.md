  ...
  <div style="padding-left: 40px;">
    ...
    <div style="text-align: center;">
      <div style="display: flex; flex-wrap: wrap; gap: 16px; ">
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">· Multiple Access</div>
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">· Rich Interfaces</div>
      </div>
      <div style="display: flex; flex-wrap: wrap; gap: 16px;margin-top:16px">
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">· Built-in DSA</div>
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px; ">· Cloud Management</div>
      </div>
    </div>
  </div>
</div>
...
<table style="width:100%; table-layout:fixed; font-size:11px;">
  ...
  <tr><td style="white-space: nowrap;">IG502-EN00-IO-W-G</td><td>Global (No Cellular)</td><td>No cellular</td><td>S</td><td>IO</td><td>W</td><td>G</td></tr>
  <tr><td style="white-space: nowrap;">IG502-EN00-D485-IO-W-G</td><td>Global (No Cellular)</td><td>No cellular</td><td>D485</td><td>IO</td><td>W</td><td>G</td></tr>
</table>
