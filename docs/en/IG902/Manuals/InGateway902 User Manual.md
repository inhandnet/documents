# 1. Product Introduction[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#product-introduction "Permalink to this headline")

## 1.1 Overview[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#overview "Permalink to this headline")
...
![](images/img_88fa1490.png)

## 1.2 Packing List[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#packing-list "Permalink to this headline")
...
## 1.3 Panel introduction and Structure and Dimensions[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#panel-introduction-and-structure-and-dimensions "Permalink to this headline")

### 1.3.1 Panel[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#panel "Permalink to this headline")
...
![](images/img_4ba25f02.png)

### 1.3.2 Structure and Dimensions[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#structure-and-dimensions "Permalink to this headline")

The structural and dimensions of IG902 are shown in the following figure:

![](images/img_ff10e4d7.png)

## 1.4 Panel Indicators[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#panel-indicators "Permalink to this headline")

### 1.4.1 LED Indicator[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#led-indicator "Permalink to this headline")

![](images/img_9901c7f4.png)

![](images/img_14ee9646.png)
...
### 1.4.2 Signal Status Indicator[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#signal-status-indicator "Permalink to this headline")

![](images/img_0451941d.png)
...
![](images/img_2bb7898d.png)

Signal: 10–19, indicating that signal and device operation are normal.

![](images/img_8430e16f.png)

Signal: 20–31, indicating good signal.

# 2. Installation[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#installation "Permalink to this headline")

## 2.1 Precautions[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#precautions "Permalink to this headline")
...
## 2.2 Installing and Uninstalling the Device on a DIN-Rail[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#installing-and-uninstalling-the-device-on-a-din-rail "Permalink to this headline")

### 2.2.1 Installing with a DIN-Rail[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#installing-with-a-din-rail "Permalink to this headline")
...
- Step 2: Insert the upper part of the DIN rail seat onto the DIN rail. Grab the lower end of the device and revolve it upward in the direction indicated by arrow 2 with gentle force, to insert the DIN rail seat onto the DIN rail. Check that the device is installed reliably on the DIN rail, as shown in following figure on the right.
  ...
  ![](images/img_dbd13c1a.png)

### 2.2.2 Uninstalling with a DIN-Rail[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#uninstalling-with-a-din-rail "Permalink to this headline")
...
- Step 2: Revolve the device in the direction indicated by arrow 2, and grab the lower end of the device and move the device outward. Lift the device when its lower end isolates from the DIN rail. Then, take off the device from the DIN rail.
  ...
  ![](images/img_dc825e04.png)

## 2.3 Installing and Uninstalling the Device in Wall-mounted Mode[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#installing-and-uninstalling-the-device-in-wall-mounted-mode "Permalink to this headline")

### 2.3.1 Installing in Wall-mounted Mode[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#installing-in-wall-mounted-mode "Permalink to this headline")
...
- Step 3: Take out the screws (packaged with the wall mounting bracket), fasten the screws in the installation positions by using the screwdriver, and pull down the device to make it secure, as shown in following figure.
  ...
  ![](images/img_0e41e169.png)

### 2.3.2 Uninstalling in Wall-mounted Mode[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#uninstalling-in-wall-mounted-mode "Permalink to this headline")
...
## 2.4 Installing a SIM Card[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#installing-a-sim-card "Permalink to this headline")
...
![](images/img_73f941ed.png)

## 2.5 Installing an Antenna[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#installing-an-antenna "Permalink to this headline")
...
## 2.6 Installing the Power Supply[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#installing-the-power-supply "Permalink to this headline")
...
- Step 3: Connect the power cable to the terminal and fasten the locking screw.
  ...
  ![](images/img_97f67394.png)

## 2.7 Installing the Ground Protection[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#installing-the-ground-protection "Permalink to this headline")
...
## 2.8 Connecting the Network Cable[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#connecting-the-network-cable "Permalink to this headline")

Connect the gateway to a PC directly by using the Ethernet cable.

![](images/img_5d2b1fbb.png)

## 2.9 Connecting Terminals[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#connecting-terminals "Permalink to this headline")
...
![](images/img_5ba016b9.png)

Note: This section is only applicable to IG902 with industrial interfaces.

# 3. Device Configuration[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#device-configuration "Permalink to this headline")

## 3.1 Gateway Access[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#gateway-access "Permalink to this headline")
...
- Step 2: Start the browser to visit the IP address of GE 0/2 on the IG902, and enter the user name and password on the login page that appears. The factory default user name and password of the IG902 are **adm** and **123456**, respectively.
  ...
  ![](images/img_d4da9568.png)

- Step 3: After logging in, you will see the web page as shown in the following figure.
  
  ![](images/img_eb9e1ed7.png)

## 3.2 Overview[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#id1 "Permalink to this headline")
...
- Network Connection Status: shows the IG902’s network connection status and network configuration.
  ...
  - External network status: When you click **Set UP**, the 3.3.3.1 Static Routing page appears.
  - Network status of GE 0/1: When you click **Set UP**, the 3.3.1.2 Ethernet page appears.
  - Network status of GE 0/2: When you click **Set UP**, the 3.3.1.2 Ethernetpage appears.
  
  ![](images/img_cb6f087a.png)

- Edge Computing: shows the status of Python edge computing.
  
  ![](images/img_fa01ebeb.png)

- Data Usage Monitoring: shows the usage of data traffic in the last 24 hours. One data record is produced every hour.
  
  ![](images/img_6771fc24.png)

- CPU Load: shows the CPU usage in the last 1 minute, 5 minutes, and 15 minutes.
  
  ![](images/img_ae357be0.png)

- Memory: shows the current memory usage.
  
  ![](images/img_97374bd6.png)

- System Information: You can click the Edit icon to change name of the IG902.
  
  ![](images/img_b6092178.png)

## 3.3 Network[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#network "Permalink to this headline")

### 3.3.1 Network Interfaces[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#network-interfaces "Permalink to this headline")

### 3.3.1.1 Cellular[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#cellular "Permalink to this headline")
...
3. Set the parameters (default settings recommended). For details about these parameters, see cellular network parameter [description](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#cellular-parameter-description).
...
### 3.3.1.2 Ethernet[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#ethernet "Permalink to this headline")
...
### 3.3.1.3 WLAN[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#wlan "Permalink to this headline")
...
### 3.3.1.4 Bridge[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#bridge "Permalink to this headline")
...
### 3.3.1.5 Loopback[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#loopback "Permalink to this headline")
...
![](images/img_5758e76f.png)

Caution: You can set a maximum of 10 secondary IP addresses for the loopback interface.  

### 3.3.2 Network Services[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#network-services "Permalink to this headline")

### 3.3.2.1 DHCP[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#dhcp "Permalink to this headline")

### 3.3.2.1.1 DHCP Server[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#dhcp-server "Permalink to this headline")
...
- Static IP Setting: allows you to bind a fixed IP address to a MAC address, as shown in the following figure.
  ...
  ![](images/img_15155a32.png)

### 3.3.2.1.2 DHCP Relay[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#dhcp-relay "Permalink to this headline")
...
### 3.3.2.2 DNS[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#dns "Permalink to this headline")
...
- Follow these steps to configure the DNS relay service:
  ...
  ![](images/img_90768db8.png)

### 3.3.2.3 GPS[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#gps "Permalink to this headline")
...
### 3.3.2.4 Host List[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#host-list "Permalink to this headline")
...
![](images/img_793491be.png)  

### 3.3.3 Routing[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#routing "Permalink to this headline")

### 3.3.3.1 Routing Status[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#routing-status "Permalink to this headline")
...
![](images/img_ecdeec4f.png)

### 3.3.3.2 Static Routing[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#static-routing "Permalink to this headline")
...
### 3.3.4 Firewall[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#firewall "Permalink to this headline")

### 3.3.4.1 ACL[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#acl "Permalink to this headline")
...
### 3.3.4.2 NAT[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#nat "Permalink to this headline")
...
## 3.4 Edge Computing[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#edge-computing "Permalink to this headline")

### 3.4.1 Python Edge Computing[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#python-edge-computing "Permalink to this headline")
...
### 3.4.2 Docker Manager[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#docker-manager "Permalink to this headline")
...
## 3.5 System[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#system "Permalink to this headline")

### 3.5.1 System Time[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#system-time "Permalink to this headline")
...
### 3.5.2 System Logs[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#system-logs "Permalink to this headline")
...
### 3.5.3 Configuration Management[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#configuration-management "Permalink to this headline")
...
### 3.5.4 Device Manager[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#device-manager "Permalink to this headline")
...
### 3.5.5 Firmware Upgrade[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#firmware-upgrade "Permalink to this headline")
...
### 3.5.6 Access Tools[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#access-tools "Permalink to this headline")
...
### 3.5.7 User Management[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#user-management "Permalink to this headline")
...
### 3.5.8 Reboot[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#reboot "Permalink to this headline")
...
![](images/img_70e32b55.png)

### 3.5.9 Network Tools[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#network-tools "Permalink to this headline")
...
![](images/img_fe687a2b.png)

### 3.5.10 3rd Party Notification[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#rd-party-notification "Permalink to this headline")
...
## 3.6 Navigation Bar Operations[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#navigation-bar-operations "Permalink to this headline")

### 3.6.1 Returning to the Homepage[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#returning-to-the-homepage "Permalink to this headline")
...
![](images/img_b782794a.png)

### 3.6.2 Logging Out[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#logging-out "Permalink to this headline")

To log out from the IG902, click the user name in the upper right corner.

![](images/img_b45de36d.png)

### 3.6.3 Changing the Language[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#changing-the-language "Permalink to this headline")
...
![](images/img_319b3f0f.png)

# 4. Advanced Functions[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#advanced-functions "Permalink to this headline")

## 4.1 Administration[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#administration "Permalink to this headline")

### 4.1.1 System[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#id2 "Permalink to this headline")
...
### 4.1.2 AAA[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#aaa "Permalink to this headline")
...
### 4.1.2.1 Radius[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#radius "Permalink to this headline")
...
### 4.1.2.2 Tacacs+[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#tacacs "Permalink to this headline")
...
### 4.1.2.3 LDAP[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#ldap "Permalink to this headline")
...
### 4.1.2.4 AAA Settings[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#aaa-settings "Permalink to this headline")
...
### 4.1.3 Alarm[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#alarm "Permalink to this headline")
...
## 4.2 Link Backup[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#link-backup "Permalink to this headline")
...
### 4.2.1 SLA[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#sla "Permalink to this headline")
...
### 4.2.2 Track Module[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#track-module "Permalink to this headline")
...
### 4.2.3 VRRP[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#vrrp "Permalink to this headline")
...
### 4.2.4 Interface Backup[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#interface-backup "Permalink to this headline")
...
## 4.3 Routing[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#id3 "Permalink to this headline")
...
### 4.3.1 Static Routing[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#id4 "Permalink to this headline")
...
### 4.3.2 Dynamic Routing[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#dynamic-routing "Permalink to this headline")
...
### 4.3.2.1 RIP[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#rip "Permalink to this headline")
...
### 4.3.2.2 OSPF[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#ospf "Permalink to this headline")
...
### 4.3.2.3 Filtering Route[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#filtering-route "Permalink to this headline")
...
### 4.3.3 Multicast Routing[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#multicast-routing "Permalink to this headline")
...
### 4.3.3.1 Basic Settings[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#basic-settings "Permalink to this headline")
...
### 4.3.3.2 IGMP[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#igmp "Permalink to this headline")
...
## 4.4 VPN[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#vpn "Permalink to this headline")
...
### 4.4.1 IPsec[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#ipsec "Permalink to this headline")
...
### 4.4.1.1 IPsec Setting[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#ipsec-setting "Permalink to this headline")
...
### 4.4.1.2 IPsec Extension Setting[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#ipsec-extension-setting "Permalink to this headline")
...
### 4.4.2 GRE[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#gre "Permalink to this headline")
...
### 4.4.3 L2TP[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#l2tp "Permalink to this headline")
...
### 4.4.3.1 L2TP Client[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#l2tp-client "Permalink to this headline")
...
### 4.4.3.2 L2TP Server[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#l2tp-server "Permalink to this headline")
...
### 4.4.4 OpenVPN[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#openvpn "Permalink to this headline")
...
### 4.4.4.1 OpenVPN Client[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#openvpn-client "Permalink to this headline")
...
### 4.4.4.2 OpenVPN Server[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#openvpn-server "Permalink to this headline")
...
### 4.4.5 Certificate Management[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#certificate-management "Permalink to this headline")
...
- FQDN: specifies the fully qualified domain name (FQDN) of the certificate. FQDN is the unique identifier of an entity on a network and is composed of a host name and a domain name. It can be resolved into an IP address. For example, host name www and domain name whatever.com form an FQDN [www.whatever.com.](http://www.whatever.com./)
...
## 4.5 Industrial Interfaces[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#industrial-interfaces "Permalink to this headline")
...
### 4.5.1 DTU[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#dtu "Permalink to this headline")

### 4.5.1.1 Serial Port[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#serial-port "Permalink to this headline")
...
### 4.5.1.2 DTU1[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#dtu1 "Permalink to this headline")
...
### 4.5.1.3 DTU2[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#dtu2 "Permalink to this headline")

The parameters are same as those of DUT1.

### 4.5.2 I/O Interfaces[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#i-o-interfaces "Permalink to this headline")
...
## 4.6 Wizards[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#wizards "Permalink to this headline")
...
### 4.6.1 New LAN[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#new-lan "Permalink to this headline")
...
### 4.6.2 New WAN[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#new-wan "Permalink to this headline")
...
### 4.6.3 New Cellular[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#new-cellular "Permalink to this headline")
...
### 4.6.4 New IPsec Tunnel[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#new-ipsec-tunnel "Permalink to this headline")
...
# 5. FAQ[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#faq "Permalink to this headline")

## 5.1 How Do I Restore Factory Settings Through Hardware?[](http://manual.ig.inhandnetworks.com/en/latest/IG902-User-Manual-EN.html#how-do-i-restore-factory-settings-through-hardware "Permalink to this headline")
...
[Next](http://manual.ig.inhandnetworks.com/en/latest/IG902-Command-Line-Instructions-EN.html "InGateway902 Command Line Instructions")  [Previous](http://manual.ig.inhandnetworks.com/en/latest/IG902-Quick-Start-Manual.html "InGateway902 Quick Start Manual")
