  ...
  <div style="padding-left: 40px;">
    ...
    <div style="text-align: center;">
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 16px;margin-top:16px">
        <div style="width: 300px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">· Cloud Management</div>
        <div style="width: 300px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px; ">· Rich Industrial Interfaces</div>
      </div>
    </div>
  </div>
</div>
...
## <span style="color: green;">2.4 Cloud O&M</span>
...
## <span style="color: green;">3.1 Smart Manufacturing</span>
...
## <span style="color: green;">3.4 Smart Retail</span>
...
## <span style="color: green;">3.5 Environmental Monitoring</span>
...
# <span style="color: green;">4. Product Innovation Points</span>

## <span style="color: green;">4.1 Product Innovation Summary</span>
...
## <span style="color: green;">4.2 Differentiation Advantages</span>
...
## <span style="color: green;">5.1 Product Dimensions</span>
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  ...
  <div style="width: 25%;">
    <img src="images/prod_2.png" alt="Interface View" />
...
## <span style="color: green;">5.2 Hardware Parameter Table</span>
...
| Transmit Power | 802.11b: 16 dBm ±2 dBm (11 Mbps);<br/>802.11g: 16 dBm ±2 dBm (54 Mbps);<br/>802.11n @2.4 GHz: 16 dBm ±2 dBm (HT20 MCS7);<br/>802.11n @2.4 GHz: 16 dBm ±2 dBm (HT40 MCS7) |
...
| <span style="color: green;">**Device Power**</span> | |
...
# <span style="color: green;">6. Network Connectivity Capability</span>
...
## <span style="color: green;">6.2 Wired Network</span>
...
## <span style="color: green;">6.3 Wi-Fi Network</span>
...
# <span style="color: green;">7. Software Functions</span>

## <span style="color: green;">7.1 VPN and Data Security</span>
...
## <span style="color: green;">7.3 Device Management and O&M</span>
...
## <span style="color: green;">7.4 Logs and Alarms</span>
...
## <span style="color: green;">7.5 Industrial Protocols and Interfaces</span>
...
## <span style="color: green;">7.6 Network Services</span>
