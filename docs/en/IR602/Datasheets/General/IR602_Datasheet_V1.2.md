...
## <span style="color: #3eb044;">Key Features</span>
...
## <span style="color: #3eb044;">Typical Application Scenarios</span>

### <span style="color: #3eb044;">Smart Manufacturing Factory</span>
...
### <span style="color: #3eb044;">Smart Energy</span>
...
### <span style="color: #3eb044;">Smart City Municipal Facilities</span>
...
### <span style="color: #3eb044;">Transportation Infrastructure</span>
...
### <span style="color: #3eb044;">Environmental & Chemical Safety Management</span>
...
### <span style="color: #3eb044;">Emergency Communication</span>
...
## <span style="color: #3eb044;">Product Dimensions</span>

<div style="text-align: center;">
    <img src="images/IR602_尺寸图_update.png" alt="Dimensions" style="width: 65%; max-height: 400px; object-fit: contain; display: block; margin: 0 auto;"/>
    <div style="text-align: center; font-size: 12px;">Dimensions</div>
</div>
<div>
    <div><strong>Note:</strong></div>
    <div>1. All dimensions are in millimeters (mm).</div>
    <div>2. Dimensions (L &times; W &times; H): 98.3 &times; 92 &times; 24 mm (3.87 &times; 3.62 &times; 0.94 in).</div>
    <div>3. All dimensions are approximate and <span style="font-weight: bold;">for reference only</span>.</div>
    <div>4. Dimensions are subject to change without notice.</div>
</div>

<div style="page-break-after: always;"></div>

# <span style="color: #3eb044;">2. Product Highlights</span>

## <span style="color: #3eb044;">Highlight 1: Unified Three-Link Architecture for All-Scenario Networking</span>
...
## <span style="color: #3eb044;">Highlight 2: Lightweight 5G Smooth Evolution for Large-Scale Deployment</span>
...
## <span style="color: #3eb044;">Highlight 3: Enterprise-Grade Security for Encrypted Remote Networking</span>
...
# <span style="color: #3eb044;">4. Network Connectivity</span>

## <span style="color: #3eb044;">4.1 Cellular Network</span>
...
## <span style="color: #3eb044;">4.4 Wi-Fi 6 Wireless</span>
...
# <span style="color: #3eb044;">5. Link Management & Backup</span>

## <span style="color: #3eb044;">5.1 Intelligent Link Backup</span>
...
## <span style="color: #3eb044;">5.2 Link Quality Assurance</span>
...
# <span style="color: #3eb044;">6. Security Features</span>

## <span style="color: #3eb044;">6.1 Firewall</span>
...
## <span style="color: #3eb044;">6.2 VPN Support</span>
...
## <span style="color: #3eb044;">7.4 Static Routing</span>

- **Routing Table**: Static routing configuration
- **Dynamic Routing**: BGP, OSPF supported

## <span style="color: #3eb044;">7.5 IP Passthrough</span>
...
# <span style="color: #3eb044;">8. Cloud Management & Maintenance</span>
...
## <span style="color: #3eb044;">8.1 DeviceLive Cloud Management</span>
...
# <span style="color: #3eb044;">9. System Management & Maintenance</span>

## <span style="color: #3eb044;">9.1 Device Management</span>
...
## <span style="color: #3eb044;">9.2 Logs & Diagnostics</span>
...
## <span style="color: #3eb044;">9.3 Other System Capabilities</span>
...
# <span style="color: #3eb044;">10. Ordering Information</span>
...
# <span style="color: #3eb044;">11. Reliability Standards & Certifications</span>

## <span style="color: #3eb044;">11.1 Ingress Protection</span>

- **IP Protection**: IP30 (dust and solid object protection)

## <span style="color: #3eb044;">11.2 Mechanical Reliability</span>
...
## <span style="color: #3eb044;">11.3 EMC Immunity</span>
...
## <span style="color: #3eb044;">11.4 Certifications & Compliance</span>
...
# <span style="color: #3eb044;">12. Contact Us</span>
