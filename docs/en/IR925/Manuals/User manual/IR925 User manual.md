# Industrial Router IR925 User manual
...
<p align="center"><strong>Figure 1 Graphical Interface Conventions</strong></p>
...
| Configure DeviceLive cloud management | [Common Scenario Configurations](#chapter-3-common-scenario-configurations) | About 10 minutes |
...
| Troubleshoot device issues | [Troubleshooting](#appendix-troubleshooting) | As needed |
...
<p align="center"><strong>图 1-1 IR925 Device Overview </strong></p>
...
<p align="center"><strong>Figure 1-1 Reset Button</strong></p>
...
2. Power on the device. The IR925 router will automatically establish a dial-up connection and connect to the network.
...
**Operation Steps**：
1. Use an Ethernet cable to connect the IR925's WAN1/LAN1 port to the uplink device.
2. To configure a second wired link, manually add a WAN link under **Internet > Uplink List** and select the appropriate connection mode (this port supports three wired access modes: DHCP, Static IP, and PPPoE).
3. After completing the settings, use an Ethernet cable to connect the IR925's LAN2/WAN2 port to the uplink device.
...
**Verification Methods**：
1. Check the WAN interface status under **Dashboard > Interface Status**.
...
<p align="center"><strong>图 3-2 Wi-Fi(STA) Configuration</strong></p>
...
<p align="center"><strong>Figure 3-4 DeviceLive Register</strong></p>
...
<p align="center"><strong>Figure 3-5 DeviceLive Login</strong></p>
...
<p align="center"><strong>Figure 3-6 Add Device</strong></p>
...
- The IR925 applies a license policy with free basic features and paid advanced features. Standard device management and monitoring functions are available for free. To use features such as cloud connectivity, purchase an advanced license under **Subscriptions > Licenses**.
...
<p align="center"><strong>Figure 4-8 Link Monitoring</strong></p>
...
<p align="center"><strong>Figure 4-9 Cellular Signal</strong></p>
...
<p align="center"><strong>Figure 4-10 Clients</strong></p>
...
<p align="center"><strong>Figure 4-11 VPN Status</strong></p>
...
<p align="center"><strong>Figure 4-12 GNSS Positioning Information</strong></p>
...
<p align="center"><strong>Figure 4-13 Routing Table</strong></p>
...
<p align="center"><strong>Figure 4-14 I/O Status</strong></p>
...
<p align="center"><strong>Figure 4-15 Events</strong></p>
...
<p align="center"><strong>Figure 4-16 Logs</strong></p>
...
The parameters and operation modes for each upstream interface can be configured under the **Internet** function. The IR925 supports three access network modes: wired, cellular, and Wi-Fi. It can support up to three upstream links, including WAN, cellular, and Wi-Fi (STA).
...
**Cautions:**
1. Upon adding Wi-Fi (STA), the IR925 will automatically disable SSIDs in the same frequency band within the Wi-Fi settings, and the status field for those SSIDs cannot be modified.
...
<p align="center"><strong>Figure 4-23 Uplink Table</strong></p>
...
<p align="center"><strong>Figure 4-24 Uplink Settings</strong></p>
...
<p align="center"><strong>Figure 4-25 Local Network List</strong></p>

Click the **Add/Edit** button to add a new local network or edit an existing one.

![alt text](./img/image-34.png)

<p align="center"><strong>Figure 4-26 Local Network Add/Edit </strong></p>
...
<p align="center"><strong>Figure 4-27 Wi-Fi List</strong></p>

To add a new SSID or edit an existing one, navigate to 【Wi-Fi】→【Wi-Fi List】 and click the "Add/Edit" button.

![alt text](./img/image-36.png)
<p align="center"><strong>Figure 4-28 SSID Add/Edit</strong></p>
...
<p align="center"><strong>Figure 4-29 Static Routing</strong></p>
...
<p align="center"><strong>Figure 4-30 IPSec VPN Configuration</strong></p>
...
<p align="center"><strong>Figure 4-31 L2TP VPN Client Configuration</strong></p>
...
<p align="center"><strong>Figure 4-32 L2TP VPN Server Configuration</strong></p>
...
<p align="center"><strong>Figure 4-33 Inbound/Outbound Rules Configuration</strong></p>
...
<p align="center"><strong>Figure 4-34 Port Forwarding Configuration</strong></p>
...
<p align="center"><strong>Figure 4-35 NAT</strong></p>
...
<p align="center"><strong>Figure 4-36 MAC Address Filtering Configuration</strong></p>
...
<p align="center"><strong>Figure 4-37 Domain Name Filtering</strong></p>
...
<p align="center"><strong>Figure 4-38 Policy-Based Routing Configuration</strong></p>
...
<p align="center"><strong>Figure 4-39 Portal Configuration</strong></p>
...
<p align="center"><strong>Figure 4-40 Internal Portal Configuration</strong></p>
...
<p align="center"><strong>Figure 4-41 External Portal Configuration</strong></p>
...
<p align="center"><strong>Figure 4-42 Interface Management List</strong></p>

![alt text](./img/image-52.png)
<p align="center"><strong>Figure 4-43 Interface Management Configuration</strong></p>
...
<p align="center"><strong>Figure 4-44 DHCP Server Configuration</strong></p>
...
<p align="center"><strong>Figure 4-45 DNS Server Configuration</strong></p>
...
<p align="center"><strong>Figure 4-46 Fixed Address List Configuration</strong></p>
...
<p align="center"><strong>Figure 4-47 Dynamic DNS Configuration</strong></p>
...
<p align="center"><strong>Figure 4-48 GNSS Configuration</strong></p>**GNSS IP Forwarding**
...
<p align="center"><strong>Figure 4-49 GNSS IP Forwarding</strong></p>**GNSS Serial Forwarding**
...
<p align="center"><strong>Figure 4-50 GNSS Serial Forwarding</strong></p>
...
<p align="center"><strong>Figure 4-51 AT Services</strong></p>
...
<p align="center"><strong>Figure 4-52 Industrial Serial Port Configuration</strong></p>
...
<p align="center"><strong>Figure 4-53 Industrial I/O Configuration</strong></p>
...
<p align="center"><strong>Figure 4-54 Cloud Management Configuration</strong></p>
...
<p align="center"><strong>Figure 4-55 Remote Access Control Configuration</strong></p>
...
<p align="center"><strong>Figure 4-56 Country & System Clock Configuration</strong></p>
...
<p align="center"><strong>Figure 4-57 Device Options</strong></p>
...
<p align="center"><strong>Figure 4-58 Configuration Management</strong></p>
...
<p align="center"><strong>Figure 4-59 Device Alarms Configuration</strong></p>
...
<p align="center"><strong>Figure 4-60 Email Server Configuration</strong></p>
...
<p align="center"><strong>Figure 4-61 Ping Tool</strong></p>
...
<p align="center"><strong>Figure 4-62 Traceroute Tool</strong></p>
...
<p align="center"><strong>Figure 4-63 Packet Capture Tool</strong></p>
...
<p align="center"><strong>Figure 4-64 Iperf Tool</strong></p>
...
<p align="center"><strong>Figure 4-65 Scheduled Reboot Configuration</strong></p>
...
<p align="center"><strong>Figure 4-66 Log Server Configuration</strong></p>
...
<p align="center"><strong>Figure 4-67 Account Management</strong></p>

### 4.12.11 Other Settings

![alt text](./img/image-77.png)
<p align="center"><strong>Figure 4-68 Other Settings</strong></p>
...
1. Complete device installation and cellular networking as described in [Installation and First Use](#chapter-2-installation-and-first-time-use).
...
- [Cellular Networking](#scenario-1-cellular-networking)
- [VPN Configuration](#46-vpn)
- [Connecting to the Device Live Platform](#scenario-4-connect-to-devicelive-cloud-platform)
...
|------|----------|----------|----------|
| Cannot connect to the cellular network | SIM card not inserted or poor contact | 1. Check whether the SIM card is inserted correctly.<br>2. Re-insert the SIM card. | [Cellular Networking](#scenario-1-cellular-networking) |
| Cannot connect to the cellular network | Incorrect APN parameters | 1. Verify the APN parameters.<br>2. Contact the carrier to obtain the correct APN. | [Cellular Connection](#433-5g4g-connection) |
| Cannot connect to the cellular network | Weak or no signal | 1. Check whether the antenna is connected.<br>2. Adjust the device position. | [Before Installation](#21-pre-installation-preparation) |
| Cannot access the network via wired connection | Ethernet cable connection failure | 1. Check whether the Ethernet cable is firmly connected.<br>2. Try a replacement cable. | [Wired Network Access](#scenario-2-wired-networking) |
| Cannot access the network via wired connection | Incorrect WAN/LAN port mode | 1. Confirm that the port is in WAN mode.<br>2. Check the port configuration in the **Internet** menu. | [Wired Connection](#431-wired-connection) |
| Cannot access the network via Wi-Fi (STA) | Incorrect SSID or password | 1. Verify the SSID and password.<br>2. Confirm the AP signal strength. | [Wi-Fi Network Access](#scenario-3-wi-fi-sta-networking) |
| Cannot access the network via Wi-Fi (STA) | Authentication policy mismatch | 1. Check the AP's authentication and encryption policies.<br>2. Ensure the IR925 configuration matches the AP. | [Wireless Connection](#432-wireless-connection) |

## 2 Web Access Issues

| Symptom | Possible Cause | Troubleshooting Steps | Reference |
|------|----------|----------|----------|
| Cannot open the web interface | Incorrect IP address | 1. Confirm that the PC and the device are on the same subnet.<br>2. Check the device's default IP. | [Logging In to the Web Management Interface](#224-access-the-web-management-interface) |
| Cannot open the web interface | Browser compatibility issues | 1. Try another browser (Chrome recommended).<br>2. Clear the browser cache. | [Logging In to the Web Management Interface](#224-access-the-web-management-interface) |
| Forgot the login password | Password not recorded | 1. Check the product nameplate.<br>2. If the password was changed and forgotten, restore factory defaults. | [Restoring Factory Defaults](#14-restore-factory-defaults) |

## 3 VPN Connection Issues

| Symptom | Possible Cause | Troubleshooting Steps | Reference |
|------|----------|----------|----------|
| IPSec VPN tunnel cannot be established | Pre-shared key mismatch | 1. Verify that the pre-shared keys on both ends are identical. | [IPSec VPN](#471-ipsec-vpn) |
| IPSec VPN tunnel cannot be established | Incorrect peer address configuration | 1. Configure the server side as 0.0.0.0.<br>2. Enter the server's public address on the client side. | [IPSec VPN](#471-ipsec-vpn) |
| IPSec VPN tunnel cannot be established | IKE policy mismatch | 1. Verify the encryption algorithm, authentication algorithm, DH group, and other parameters on both ends. | [IPSec VPN](#471-ipsec-vpn) |
| L2TP VPN tunnel cannot be established | Incorrect username/password | 1. Verify that the usernames and passwords on both ends are identical. | [L2TP VPN](#472-l2tp-vpn) |
| L2TP VPN tunnel cannot be established | Server address unreachable | 1. Check network connectivity.<br>2. Confirm the server address is correct. | [L2TP VPN Client](#472-l2tp-vpn) |

## 4 Cloud Platform Connection Issues

| Symptom | Possible Cause | Troubleshooting Steps | Reference |
|------|----------|----------|----------|
| Device cannot go online on Device Live | Device not connected to the Internet | 1. Confirm that the device is connected to the Internet.<br>2. Check the cellular/wired/Wi-Fi connection status. | [Connecting to the Device Live Platform](#scenario-4-connect-to-devicelive-cloud-platform) |
| Device cannot go online on Device Live | Incorrect serial number | 1. Verify that the serial number entered matches the device nameplate. | [Connecting to the Device Live Platform](#scenario-4-connect-to-devicelive-cloud-platform) |
| Device cannot go online on Device Live | Cloud management disabled | 1. Confirm that cloud management is enabled under **System > Cloud Management**. | [Cloud Management](#4121-cloud-management) |
