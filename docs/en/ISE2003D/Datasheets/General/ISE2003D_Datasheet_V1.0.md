<div style="width: 100%;height: 100%;background: url(images/ISE2003.png); background-size: 100% 100%;">
  <div style="height:75%;">
  ...
  <div style="padding-left: 40px;">
    <div style="font-size: 40px; font-weight: bold; color:#000;margin-bottom: 30px;">
      ISE2003D Unmanaged Industrial Ethernet Switch
    </div>
...
**The ISE2003D is designed for power, transportation, industrial control, and demanding industrial environments.**
...
| Ports | 1 x Fixed Fiber (SC) + 2 x 10/100BaseT |
...
| Certifications | CE, FCC, UL (ISE2003D-P-S203-2T-SC-24) |
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/media_1_5.jpeg" width="100%" alt="ISE2003D Dimensions" />
    <div style="width: 100%; text-align: center; font-size: 12px;">ISE2003D</div>
  </div>
  <div style="width: 100%;">
    <div>Note:</div>
...
| Model | Description |
|-------|--------|
| ISE2003D-P-S203-2T-SC-24 | 3-port Layer 2 unmanaged Industrial Ethernet. 1 × Fixed Fiber Port (MultiMode, 5KM, SC), and 2 × 10/100 BaseT Ports. IP30 Protection Class, Operating Temperature from -40°C to +75°C. Single power input: 12/24/48 VDC (9.6\~60VDC) or 24 VAC (18\~30 VAC) (Only connect to class 2 power supply). |
| ISE2003D-P-M3-2T-SC-24 | 3-port Layer 2 unmanaged Industrial Ethernet. 1 × Fixed Fiber Port (SingleMode, 20KM, SC), and 2 × 10/100 BaseT Ports. IP30 Protection Class, Operating Temperature from -40°C to +75°C. Single power input: 12/24/48 VDC (9.6\~60VDC) or 24 VAC (18\~30 VAC) (Only connect to class 2 power supply). |
