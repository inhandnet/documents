<div style="width: 100%;height: 100%;background: url(images/ISE5306.png); background-size: 100% 100%;">
  ...
  <div style="padding-left: 40px;">
    <div style="font-size: 40px; font-weight: bold; color:#000;margin-bottom: 30px;">
      ISE5006D Unmanaged Industrial Ethernet Switch
    </div>
...
**The ISE5006D is designed for power, transportation, industrial control, and demanding environments.**
...
- **Flexible Uplink:** 2×SFP fiber ports plus 4×Gigabit RJ45 ports for versatile networking.
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: center;row-gap: 16px;">
  <div style="width: 60%;">
    <img src="images/prod_1.png" width="100%" alt="ISE5006D" />
    <div style="width: 100%; text-align: center; font-size: 12px;">ISE5006D</div>
  </div>
  <div style="width: 100%;">
    <div>Note:</div>
...
| Model | Description |
|-------|--------|
| ISE5006D-P-2GSFP-4GT-24 | Layer 2 unmanaged Industrial Switch. 2 *100/ 1000BaseX SFP Ports (SFP module not included), 4* 10/ 100/ 1000 BaseT Ports. IP40 Protection Class, Operating Temperature from -40 °C to +75 °C (-40 °F to +167 °F). Isolated Dual 18-60VDC Power Inputs.|
