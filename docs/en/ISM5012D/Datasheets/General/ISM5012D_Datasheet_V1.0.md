<div style="width: 100%;height: 100%;background: url(images/ISM5012.png); background-size: 100% 100%;">
  <div style="height:75%;">
  ...
  <div style="padding-left: 40px;">
    <div style="font-size: 40px; font-weight: bold; color:#000;margin-bottom: 30px;">
      ISM5012D Managed Industrial Ethernet Switch
    </div>
...
- **Reliability & Resilience:** Fanless design, IP40 protection rating, dust and dirt resistance, and wide temperature operation (-40 °C ~ 85 °C (-40 °F ~ 185 °F)).
...
- **Linear Industrial Switches:** High performance, flexible linear switches catering perfectly to industrial deployments.
...
| Ports | 4 x 100/1000BaseX SFP + 8 x 10/100/1000BaseT |
| Switching Performance | 55 Gbps backplane bandwidth; 8K MAC table |
| Dimensions / Weight | 72 mm x 140 mm x 110 mm; 1 kg (2.2 lb) |
| Power | 18\~60 VDC dual redundant input |
| Environment | -40 °C ~ +85 °C (-40 °F ~ +185 °F) operating; IP40 |
| EMC | FCC Part 15 Class A; IEC 61000-4-2/3/4/5/6/9 |
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/media_1_3.jpeg" width="80%" style="display: block; margin: 0 auto;" alt="ISM5012D Dimensions" />
    <div style="width: 100%; text-align: center; font-size: 12px; margin-top: 8px;">ISM5012D</div>
  </div>
</div>
  <div style="width: 100%;">
    <div>Note:</div>
...
| Input Voltage | 18\~60 VDC dual redundant input |
| Overload Current Protection | Supported |
| Reverse Polarity Protection | Supported |
| <span style="color: green;">**Electromagnetic Characteristics**</span> | |
| EMI | FCC 47 CFR Part 15 Class A; EN55022 Class A |
| EMS | IEC(EN)61000-4-2, Class 4 <br/> IEC(EN)61000-4-3, Class 3 <br/> IEC(EN)61000-4-4, Class 4 <br/> IEC(EN)61000-4-5, Class 4 <br/> IEC(EN)61000-4-6, Class 3 <br/> IEC(EN)61000-4-9, Class 5 |
...
| Others | 4K VLANS, IPv4/IPv6 multicast, storm control, support Jumbo Frame |
...
| Model | Description |
|-------|-------------|
| ISM5012D-P-4GSFP-8GT-24 | 12-port Layer 2 managed Industrial Switch. 4 \* 100/1000 BaseX SFP Ports and 8 \* 10/100/1000BaseT Ports. Isolated Dual 18-60VDC Power Inputs. IP40 Protection Class. |
