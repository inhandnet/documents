<div style="width: 100%;height: 100%;background: url(images/ISM5026.png); background-size: 100% 100%;">
  <div style="height:75%;">
  ...
  <div style="padding-left: 40px;">
    <div style="font-size: 40px; font-weight: bold; color:#000;margin-bottom: 30px;">
      ISM5026U-P Managed Industrial Ethernet Switch
    </div>
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/media_1_3.jpeg" width="80%" style="display: block; margin: 0 auto;" alt="ISM5026U-P Dimensions" />
    <div style="width: 100%; text-align: center; font-size: 12px; margin-top: 8px;">ISM5026U</div>
  </div>
</div>
...
| Management Mode | Browser, Serial Port, STD-17 MIB-II, STD-58 SMIv2, STD-59 RMON, STD-62 SNMPv3, SNMPv2c, SNMPv1, SSH, HTTPS, Telnet |
