<div style="width: 100%;height: 100%;background: url(images/ISM5006.png); background-size: 100% 100%;">
  ...
  <div style="padding-left: 40px;">
    <div style="font-size: 40px; font-weight: bold; color:#000;margin-bottom: 30px;">
      ISM5306D PoE Managed Industrial Ethernet Switch
    </div>
...
**The ISM5306D PoE managed industrial Ethernet switch is specifically designed to meet the demands of harsh industrial environments such as power, transportation, and industrial control applications.**
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: center;row-gap: 16px;">
  <div style="width: 40%;">
    <img src="images/ISM5306D.png" width="100%" style="display: block; margin: 0 auto;" alt="ISM5306D Dimensions" />
    <div style="width: 100%; text-align: center; font-size: 12px;">ISM5306D</div>
  </div>
  <div style="width: 100%;">
    <div>Note:</div>
