<div style="width: 100%;height: 100%;background: url(images/ISM7028.png); background-size: 100% 100%;">
  <div style="height:75%;">
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/media_1_3.jpeg" width="80%" style="display: block; margin: 0 auto;" alt="ISM7028U-P Dimensions" />
    <div style="width: 100%; text-align: center; font-size: 12px; margin-top: 8px;">ISM7028U</div>
  </div>
</div>
  <div style="width: 100%;">
    <div>Note:</div>
