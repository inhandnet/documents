...
1. **Prepare**: USB Type-C supply (5 V / 5 A), Micro SD card ≥ 16 GB Class 10 (or faster), PWM fan (4-pin, 5 V), downloaded Mo 68A Armbian image, RJ45 cable; for desktop use, also have a Mini DisplayPort cable, DisplayPort monitor, USB keyboard and mouse.
...
![Mo 68A board layout](images/MO68A_label.webp)
...
| RTC battery (CR2032, 2-pin JST-SH class) | Persistent clock (see User Guide [§11 RTC](../User manual/Mo 68A_User manual_V1.0.md#11-rtc)) |
...
Download the Mo 68A Armbian image from the **InHand website** and save it on the host computer you use for flashing.
...
![Mo 68A wired example](images/MO68A_setup.webp)
...
Pin/signal definitions, software setup, and usage examples for the **40-pin GPIO header** and the **two MIPI 22-pin FPC** connectors (camera / DSI display, etc.) are in the **Mo 68A User Guide**: [§14 40-pin GPIO Header](../User manual/Mo 68A_User manual_V1.0.md#14-40-pin-gpio-header), [§15 MIPI FPC Ports](../User manual/Mo 68A_User manual_V1.0.md#15-mipi-fpc-ports), and the following display and camera sections.
...
| --- | --- | --- |
| **No display** | Monitor must accept DisplayPort (not HDMI-only); Mini DP seated in J9; correct input source | [User Guide §7](../User manual/Mo 68A_User manual_V1.0.md#7-mini-displayport) |
...
| **Power LED off** | Adapter is 5 V / 5 A; cable is on J5 (USB-C power), not another port | [Hardware Reference Manual — Power supply](Mo 68A_Hardware_Reference_Manual_V1.0.md#power-supply) |
...
| --- | --- |
| [Mo 68A User Guide](../User manual/Mo 68A_User manual_V1.0.md) | Interface usage, peripheral configuration, system administration |
| [Mo 68A Hardware Reference Manual](Mo 68A_Hardware_Reference_Manual_V1.0.md) | Connector pinouts, signal assignments, electrical specifications |
