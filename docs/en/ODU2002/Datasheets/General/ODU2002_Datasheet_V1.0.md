<div style="width: 100%;height: 100%;background: url(images/odu2000.jpg); background-size: 100% 100%;">
  <div style="height:75%;">
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between; row-gap: 16px;">
  <div style="width: 32%; flex-shrink: 0;">
    <img src="三图/正视图.png" alt="Front View" style="width: 100%; max-height: 200px; object-fit: contain; display: block; margin: 0 auto;"/>
    <div style="width: 100%; text-align: center; font-size: 12px;">Front View</div>
  </div>
  <div style="width: 32%; flex-shrink: 0;">
    <img src="images/media_1_15.png" alt="Interface" style="width: 100%; max-height: 200px; object-fit: contain; display: block; margin: 0 auto;"/>
    <div style="width: 100%; text-align: center; font-size: 12px;">Interface Dimensions</div>
  </div>
  <div style="width: 32%; flex-shrink: 0;">
    <img src="三图/侧视图.png" alt="Side View" style="width: 100%; max-height: 200px; object-fit: contain; display: block; margin: 0 auto;"/>
