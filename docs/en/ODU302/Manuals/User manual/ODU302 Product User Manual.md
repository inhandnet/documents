# Industrial Router ODU302 Product User Manual
---
...
## 1.1 Overview
The ODU302 is the outdoor cellular routers, integrating 3G, 4G LTE, and advanced security features. With embedded hardware watchdog, link detection, auto-recovery, and auto-reboot capabilities, the ODU302 provides reliable communications for unattended sites. Reliable VPN technology secures sensitive data transmissions. The ODU302 also supports remote management tools including a Web interface, and the InHand Device Manager Cloud platform for batch configuration and monitoring.

The ODU302 features IP65 ingress protection and supports PoE power input, making it highly suitable for outdoor deployment scenarios.

## 1.2 Packing List
Each ODU302 product includes the following standard accessories. Please check carefully upon receipt of the product. Contact InHand sales staff if anything is missing or damaged.
...
<!-- 这是一张图片，ocr 内容为： -->
![](images/img_a82f479d.webp)<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781754018749-baa71f3d-2dae-4a6f-9a9b-37e94e29ab8c.png)

**Fig. 1-1 Equipment Panel (Front View)**

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781754116790-381bad6c-ca1b-444d-a000-83ef28b43371.png)

**Fig. 1-2 Equipment Panel (Rear View)**

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781755018067-c97daf56-0948-41d5-a2cd-82109f52b98f.png)

**Fig. 1-3** **Equipment Panel (Bottom View)**

**Table 1-3-1 Interface Description**

| Interface | Position | Function Description |
| --- | --- | --- |
| Power | Bottom | DC power input terminal (9~36V DC) |
| WAN/LAN1 | Bottom | Configurable as WAN or LAN1 |
| PoE LAN2 | Bottom | LAN2 Ethernet port supporting PoE |
| SIM Slot | Bottom | Dual SIM card slots |
| Reset | Bottom | Reset button for restoring factory settings |
...
| --- | --- | --- |
| <font style="color:rgb(0, 0, 0);">System</font> | Off | Powered off |
| | <font style="color:rgb(0, 0, 0);">Steady in </font><font style="color:rgb(255, 0, 0);">red</font> | System powered on |
| | <font style="color:rgb(0, 0, 0);">Blink in </font><font style="color:rgb(255, 0, 0);">red</font> | System error |
| | <font style="color:rgb(0, 0, 0);">Steady in </font><font style="color:rgb(0, 176, 80);">green</font> | System working |
| | <font style="color:rgb(0, 0, 0);">Blink in</font><font style="color:rgb(0, 176, 240);"> blue</font> | System Upgrading |
| Wi-Fi | <font style="color:rgb(0, 0, 0);">Off</font> | Wi-Fi not enabled |
| | <font style="color:rgb(0, 0, 0);">Blink in </font><font style="color:rgb(0, 176, 80);">green</font> | Wi-Fi driver loading |
| | <font style="color:rgb(0, 0, 0);">Steady in </font><font style="color:rgb(0, 176, 80);">green</font> | AP working |
| Cellular  | Off | Cellular not enabled |
| | <font style="color:rgb(0, 0, 0);">Blink in </font><font style="color:rgb(255, 0, 0);">red</font> | Dialing in progress |
| | <font style="color:rgb(0, 0, 0);">Steady in </font><font style="color:rgb(0, 176, 80);">green</font> | Signal value 21~30 |
| | <font style="color:rgb(0, 0, 0);">Steady in </font><font style="color:rgb(0, 176, 240);">blue</font> | Signal value 11~20 |
| | <font style="color:rgb(0, 0, 0);">Steady in </font><font style="color:rgb(255, 0, 0);">red</font> | Signal value 0~10 |
| Ethernet Port | Off | Ethernet disconnected |
| | <font style="color:rgb(0, 0, 0);">Steady in </font><font style="color:rgb(255, 0, 0);">red</font> | Only WAN port connected |
| | <font style="color:rgb(0, 0, 0);">Steady in </font><font style="color:rgb(0, 176, 80);">green</font> | Only LAN port connected |
| | <font style="color:rgb(0, 0, 0);">Steady in </font><font style="color:rgb(0, 176, 240);">blue</font> | Both LAN and WAN ports connected |


## 1.5 Restoring Factory Settings
To restore the device to default settings using the reset button, follow these steps:

<font style="color:rgb(51, 51, 51);">When the router power on, </font>**<font style="color:rgb(51, 51, 51);">press and hold the reset button for 10 seconds</font>**<font style="color:rgb(51, 51, 51);">, the system LED will change from </font>**<font style="color:rgb(51, 51, 51);">solid</font>**<font style="color:rgb(51, 51, 51);"> blue to </font>**<font style="color:rgb(51, 51, 51);">blinking</font>**<font style="color:rgb(51, 51, 51);"> blue. The unit has been restored to default settings and will start up normally later. </font>
...
| Item | Requirement |
| --- | --- |
| Power Supply | 9~36V DC or PoE(802.3af) |
...
+ 1 PC
+ 1 SIM card (ensure data service is enabled and not suspended)
+ Power supply (9~36V DC or PoE(802.3af))

> **Caution**: The device shall be installed and operated in a powered-off state. Installation should account for the surrounding environment.
>

## 2.2 Installation Guide
 Before installation and deployment, insert a valid SIM card in advance.  

### 2.2.1  Wall Mount Installation
<!-- 这是一张图片，ocr 内容为： -->
![](images/img_6c93bac9.webp)1. Parts List

+ 4G ODU Main Unit
+ Wall/Pole Mount Bracket
+ Cable Gland Assembly: M30×1.5 Nut, Cable Rubber Seal, Gland Claw, Gland Lock Nut
+ Wall Anchor Screws Kit

2. Installation Steps

**Step 1**: Drill mounting holes on the solid wall according to the hole layout of the wall mount bracket.

**Step 2**: Assemble the cable gland in sequence: Gland Lock Nut → Gland Claw → Cable Rubber Seal → M30×1.5 Nut. Feed the whole gland assembly through the pre-drilled wall hole from outdoor side.

Connect the bottom thread of ODU unit with M30 nut of cable gland and tighten fully to maintain IP65 waterproof rating.

**Step 3**: Secure the wall mount bracket to wall with supplied anchor screws. Clip the bracket onto the side slot of ODU housing and lock tightly.

**Step 4**: Route Ethernet cable from outdoor through the gland into indoor space. Fasten the gland claw to seal the cable entry completely against rain ingress.

3. Precautions

+ This unit is IP65 outdoor rated; all threaded joints and gland components must be fully tightened for waterproof performance.
+ Install only on solid flat walls. Hollow or soft walls are not allowed to avoid bracket falling off.
+ Tighten the gland claw firmly after cable routing to eliminate gaps and prevent water penetration.

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781760463961-240350c0-0c31-41e1-adc9-2fe9662d771f.png)

**Fig. 2-1 DIN-Rail Installation**

### 2.2.2 Pole Mount Installation
1. Parts List

+ 4G ODU Main Unit
+ Universal Wall & Pole Mount Bracket
+ Cable Gland Assembly: M30×1.5 Nut, Cable Rubber Seal, Gland Claw, Gland Lock Nut
+ 0–100mm Stainless Steel Hose Clamp
+ Utility Pole

2. Installation Steps

**Step 1**:Assemble the cable gland in order: Gland Lock Nut → Gland Claw → Cable Rubber Seal → M30×1.5 Nut. Route Ethernet cable through the center of the gland with reserved slack.

**Step 2**:Thread the bottom port of ODU onto the M30×1.5 nut and fully tighten to maintain IP65 waterproof rating.

**Step 3**:Clip the universal mount bracket onto the side slot of the ODU housing and lock securely.

**Step 4**:Thread the 0–100mm hose clamp through the bracket, wrap around the utility pole, then tighten the clamp to fix the bracket firmly to the pole surface.

**Step 5**:Adjust the orientation of the ODU unit. Tighten the gland claw to compress the rubber seal against the cable and block water ingress.

3. Precautions

+ This unit is IP65 outdoor rated. All threaded joints and gland components must be fully tightened to avoid water damage.
+ Suitable for cylindrical poles with a diameter ranging from 0 mm to 100 mm.
+ Periodically check the tightness of the hose clamp for outdoor deployment to prevent the device from falling off.
+ Mount the unit above flood-prone areas with the cable port facing downwards to minimize rainwater accumulation.

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781760756970-a36c6ff8-1bad-4621-b121-6bc8a816cdb0.png)

**Fig. 2-2  Pole Mount Installation**

### 2.2.3 Cabinet Mount Disassembly
1. Included Parts
...
**Step 1**:Drill M30 standard through-hole on the cabinet mount plate to fit the threaded gland at the bottom of the ODU.

**Step 2**:Insert the threaded bottom end of the 4G ODU through the hole from the outer side of the cabinet mount plate into the cabinet interior.

**Step 3**:Screw on the M30×1.5 lock nut onto the internal thread and fully tighten, securing the ODU firmly to the plate to preserve IP65 waterproof performance.

**Step 4**:Route Ethernet cable through the ODU gland into the cabinet for internal wiring. Assemble the full cable gland kit and compress the rubber seal to block water ingress.

3. Important Notes

+ Tighten the M30 lock nut completely to prevent device loosening and water leakage under outdoor vibration.
+ The cabinet mount plate shall have sufficient structural rigidity; reinforcing ribs are required for thin sheet metal to avoid bending deformation.
+ Do not remove sealing gaskets at threaded joints, otherwise the outdoor ingress protection will fail.

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781761058738-e7c3aae9-07fe-4bb6-bd02-6c1a8cc82db8.png)

**Fig. 2-3  Cabinet Mount Installation**

### 2.2.4 Logging into the Router
...
Open a web browser and enter the IP address of the ODU302, such as `http://192.168.2.1`, in the address bar (default setting of the ODU302). Upon connection, log in from the login interface as Admin. Enter the username and password at the login interface (please check the device nameplate for the default username and password).
...
**Prerequisites**: The SIM card has been inserted and the device is powered on.

**Estimated Time**: Approx. 2 minutes.

**Operation Steps**:

1. Insert the SIM card into slot 1. Connect the network cable and power cable, then power on the device.
...
2. Open a browser and log in to the device Web interface. (Refer to Section 2.2.4 for Web login steps.)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781766575732-48e4a0ee-5201-4551-b17f-1fc110ee6824.png)

**Fig. 3-1 SIM Card Dial-Up Configuration**
...
<!-- 这是一张图片，ocr 内容为： -->
![](images/img_111a0a60.webp)<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781766632006-e4d0c88e-84b8-44a1-a759-5a15f6315974.png)

**Fig. 3-2 Dialing Parameters**
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781766671054-284b60ee-e81a-4874-ba5c-42c68be03039.png)

**Fig. 3-3 Dial-Up Connection Status**
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781767035964-2b838220-08ec-4bd1-80cb-8a93cf4dd859.png)<!-- 这是一张图片，ocr 内容为： -->
![](images/img_b02e5b16.webp)

**Fig. 3-4 Dynamic Acquisition / Manual Configuration**
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781767788259-8d2ad779-3235-45a9-9d36-2f0b6e1044af.png)

**Fig. 3-5 Login to Web Page Management**
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781767893231-821c4fd9-0725-4330-aa29-94ede925fcf3.png)

**Fig. 3-6 WAN Port Setup**
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781767929635-3aaf9cc1-97c3-4766-9845-5375b4a41916.png)

**Fig. 3-7-a Dynamic IP Configuration of WAN**

<!-- 这是一张图片，ocr 内容为： -->
![](images/img_a0064504.webp)<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781767917951-f1052c0c-f249-497f-9055-b4af0dd0fa49.png)

**Fig. 3-7-b Static IP Configuration of WAN**

<!-- 这是一张图片，ocr 内容为： -->
![](images/img_b3cf4f7e.webp)<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781767950284-105b6913-686d-4977-8a11-05ff8e482dc2.png)

**Fig. 3-7-c ADSL Dial-up of WAN**

6. Use the ping tool to verify the network connection.

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781767991427-44e39624-9a5c-44d3-957e-378c912af35d.png)

**Fig. 3-8 Ping Result Diagram**
...
## Scenario 3: DM Cloud Platform Access
...
1. Ensure the device has successfully accessed the Internet. Click **Service >> Device Remote Management Platform** in the navigation menu to set up access to the DM Cloud Platform.Server address: the address of the Device Manager. The addresses developed by InHand are as follows:

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781768062285-aa6cb18f-a287-42a1-b48a-3a151c7149b8.png)

**Fig. 3-9 Remote Platform Configuration**

    - Device Manager: iot.inhandnetworks.com
    - InConnect: ics.inhandnetworks.com
2. Register or log in to the DM Cloud Platform account. Access the registration/login page via the link: [https://iot.inhandnetworks.com](https://iot.inhandnetworks.com).

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781768283031-ffee81f9-cee9-4e2d-8a00-4ea53bc99e37.png)

**Fig. 3-10 Account Registration/Login**
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781768458894-81e8cbda-c133-4976-a7b7-91f18d2bee70.png)

**Fig. 3-11 Add Device to Platform**

3. After adding the device and successfully connecting it to the platform, select the corresponding device from the **Gateways** list, then click **Web management** under **Action** to remotely access the device configuration page.

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/12838153/1781768736368-7d559a1e-59da-4ca5-b30f-f25d12161a3b.png)

**Fig. 3-12 Remotely Access the Device Configuration Page**
...
This chapter describes the functional modules of the ODU302 and provides detailed parameter references for each configuration page. Users can navigate to the corresponding pages via the Web interface navigation tree.
...
**Function Description**: The ODU302-WLAN supports two types of WLAN modes: AP and STA. After changing and saving the configuration, reboot the device for the configuration to take effect.

### 4.2.5 WLAN Client (AP Mode)
**Path**: Navigation tree >> **Network >> WLAN**

**Function Description**: When working in AP mode, the ODU302 WLAN will provide a network access point for other wireless network devices. Ensure that the ODU302 has already connected to the Internet via WAN or cellular dial-up.
...
<!-- 这是一张图片，ocr 内容为： -->
![](images/img_9ae4cc5c.webp)

**Fig. 4-1 SNMP Topology**
...
Only the ODU302-IO supports this feature.
...
| --- | --- | --- | --- |
| Cannot access the Internet via cellular | SIM card not inserted or poor contact | 1. Check whether the SIM card is correctly inserted.   2. Reinsert the SIM card. | [SIM Card Installation](#225-sim-card-installation) |
| Cannot access the Internet via cellular | APN parameters configured incorrectly | 1. Verify whether the APN parameters are correct.   2. Contact the operator to obtain the correct APN. | [Cellular Internet Access](#scenario-1-cellular-internet-access) |
| Cannot access the Internet via cellular | Weak or no signal | 1. Check whether the antenna is connected.   2. Adjust the device position. | [Antenna Installation](#226-antenna-installation) |
| Cannot access the Internet via wired connection | WAN port not switched to WAN mode | 1. Check **Network >> WAN/LAN Switch**.   2. Set the interface to WAN mode. | [Wired Internet Access](#scenario-2-wired-internet-access) |
| Cannot access the Internet via wired connection | Upstream network failure | 1. Check whether the upstream router is working.   2. Verify the WAN IP configuration. | [WAN/LAN Switch](#422-wanlan-switch) |
| Wi-Fi not found | Wi-Fi antenna not connected | 1. Check whether the Wi-Fi antenna is connected to the WLAN interface.   2. Check whether the Wi-Fi function is enabled. | [Wi-Fi Internet Access](#scenario-3-wi-fi-internet-access) |


## A.2 Web Interface Access Issues
| Phenomenon | Possible Cause | Troubleshooting Steps | Reference Chapter |
| --- | --- | --- | --- |
| Cannot open the Web interface | IP address incorrect | 1. Confirm that the PC and the device are in the same subnet.   2. Check the device default IP (192.168.2.1). | [Logging into the Router](#229-logging-into-the-router) |
| Cannot open the Web interface | Browser compatibility issue | 1. Change the browser (Chrome is recommended).   2. Clear the browser cache. | [Logging into the Router](#229-logging-into-the-router) |
| Forgot the login password | Password lost | 1. Restore the device to factory settings via the RESET button.   2. Log in with the default password. | [Restoring Factory Settings](#15-restoring-factory-settings) |


## A.3 VPN Connection Issues
| Phenomenon | Possible Cause | Troubleshooting Steps | Reference Chapter |
| --- | --- | --- | --- |
| VPN tunnel cannot be established | Incorrect peer address | 1. Check whether the destination address is correct.   2. Verify whether the peer device is reachable. | [IPSec Tunnels](#462-ipsec-tunnels) |
| VPN tunnel cannot be established | Inconsistent pre-shared key | 1. Verify that the keys on both ends are consistent.   2. Reconfigure the key. | [IPSec Tunnels](#462-ipsec-tunnels) |
| VPN connected but data cannot pass through | Firewall blocking | 1. Check the firewall rules.   2. Add allow rules for VPN traffic. | [Firewall](#44-firewall) |


## A.4 Device Hardware Issues
| Phenomenon | Possible Cause | Troubleshooting Steps | Reference Chapter |
| --- | --- | --- | --- |
| Power LED not illuminated | Fuse burnt out | 1. Check whether the protective tube is burnt out.   2. Check the power supply voltage range and polarity. | [Power Connection](#228-power-connection) |
| Frequent auto-restart | Unstable power supply | 1. Check whether the power supply voltage is within the rated range.   2. Check whether the module is working normally. | [Installation Environment](#21-pre-installation-preparation) |
| Device overheating | Poor heat dissipation | 1. Ensure the device is installed in a well-ventilated environment.   2. Avoid direct sunlight and heat sources. | [Installation Environment](#21-pre-installation-preparation) |
...
## B.1 General Safety
1. The ODU302 router must be used in compliance with any and all applicable national and international laws and with any special restrictions regulating the utilization of the communication module in prescribed applications and environments.
...
1. Operating temperature: -30℃ to +70℃.
...
Apply the routing test of [www.g.cn](http://www.g.cn) and display the testing results.
...
1. Enter in the configured view: `username abc password 123`Add an ordinary user; the name is abc and the password is 123.
2. Enter in the configured view: `no username abc`Delete the ordinary user with the name abc.
3. Enter in the configured view: `default username`Delete all ordinary users.

---

# Appendix D Frequently Asked Questions
### Question 1: What is the difference between the ODU302 and a regular home router?
1. The ODU302 is an outdoor router, with an IP65 and operating temperature range of -30℃ to +70℃.
...
+ **Method 2**: Within 5 seconds after the InRouter is powered on, press and hold the reset button for 10 seconds, the system LED will change from solid blue to blinking blue. The unit has been restored to default settings and will start up normally later. 
