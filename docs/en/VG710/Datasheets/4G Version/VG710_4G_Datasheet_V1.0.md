<div style="width: 100%;height: 100%;background: url(images/VG710-4G.jpg); background-size: 100% 100%;">
  <div style="height:75%;">
  ...
  <div style="padding-left: 40px;">
    ...
    <div style="text-align: center;">
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 16px;margin-top:16px">
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">· Telematics</div>
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px; ">· Programmable Edge</div>
      </div>
    </div>
  </div>
</div>
...
<div style="display: flex; justify-content: space-between; column-gap: 12px;">
  <div style="width: 32%;">
    <div style="height: 210px; display: flex; align-items: center; justify-content: center;">
      <img src="VG710_4G/正视图.png" alt="Front View" style="max-width: 100%; max-height: 100%; width: auto; height: auto;" />
    </div>
    <div style="width: 100%; text-align: center; font-size: 12px; margin-top: 4px;">Front View</div>
  </div>
  <div style="width: 32%;">
    <div style="height: 210px; display: flex; align-items: center; justify-content: center;">
      <img src="VG710_4G/底部图.png" alt="Bottom View" style="max-width: 100%; max-height: 100%; width: auto; height: auto;" />
    </div>
    <div style="width: 100%; text-align: center; font-size: 12px; margin-top: 4px;">Bottom View</div>
  </div>
  <div style="width: 32%;">
    <div style="height: 210px; display: flex; align-items: center; justify-content: center;">
      <img src="VG710_4G/侧视图.png" alt="Side View" style="max-width: 100%; max-height: 100%; width: auto; height: auto;" />
    </div>
...
| <span style="color: green;">**Ports & WLAN**</span> | |
...
| <span style="color: green;">**Application Services**</span> | |
...
## <span style="color: green;">Antenna Options</span>
...
# <span style="color: green;">7. 20PIN Definition</span>
...
## <span style="color: green;">Power Pin Definition (4 pins)</span>
