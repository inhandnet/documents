...
**ISE2016D-S 专为电力、交通、工业控制及其他严酷工业环境设计。**

ISE2016D-S-16T-24 是 16 路百兆电口的工业级以太网交换机，支持 16 个 10Base-T/100Base-TX 电口。产品符合 FCC、CE、ROHS 标准，具有 -40℃ ~ +80℃ 的宽工作温度范围，能适应各种严苛环境，也可非常方便地安置在空间紧凑的控制箱中。导轨安装特性、宽温操作及 IP40 防护等级的金属外壳与 LED 指示灯，使 ISE2016D-S 成为一款即插即用的工业级设备，为用户的以太网设备联网提供可靠、便捷的解决方案。
...
|-----------|---------------|
| 类型 | 二层非网管工业以太网交换机 |
| 端口 | 16 × 10/100BaseT(X) 自适应 RJ45 端口 |
| 交换性能 | 3.2 Gbps 背板带宽，存储转发，8K MAC |
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/dimension.png" width="100%" alt="ISE2016D-S 尺寸图" />
    <div style="width: 100%; text-align: center; font-size: 12px;">ISE2016D-S</div>
  </div>
...
| 型号 | 描述 |
|-------|--------|
| ISE2016D-S-16T-24 | 16 端口二层非网管工业以太网交换机。16 × 10/100BaseT(X) 电口。IP40 防护等级，DIN 导轨式安装，工作温度 -40°C 至 +80°C。DC 12-52 V 电源输入，支持双电源冗余备份。 |
