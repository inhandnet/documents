...
**ISE5006D-S 专为电力、交通、工业控制及其他严酷工业环境设计。**

ISE5006D-S-2GSFP-4GT-24 是 2 路千兆光口 + 4 路千兆电口的工业级以太网交换机，支持 4 个 10/100/1000Base-T(X) 电口和 2 个 1000Base-X SFP 光口。产品符合 FCC、CE、ROHS 标准，具有 -40℃ ~ +80℃ 的宽工作温度范围，能适应各种严苛环境，也可非常方便地安置在空间紧凑的控制箱中。导轨安装特性、宽温操作及 IP40 防护等级的金属外壳与 LED 指示灯，使 ISE5006D-S 成为一款即插即用的工业级设备，为用户的以太网设备联网提供可靠、便捷的解决方案。
...
- **光纤上行：** 2 个千兆 SFP 光口，采用优质光电一体化模块，保证数据传输可靠，工作寿命长。
...
| 尺寸 / 重量 | 143.7 × 104 × 47.7 mm / 0.64 kg |
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/dimension.png" width="100%" alt="ISE5006D-S 尺寸图" />
    <div style="width: 100%; text-align: center; font-size: 12px;">ISE5006D-S</div>
  </div>
...
| 外壳 | 金属外壳，IP40 防护等级 |
| 尺寸 (W × D × H) | 143.7 mm × 104 mm × 47.7 mm |
| 重量 | 0.64 kg |
| 安装方式 | DIN 导轨式、壁挂式安装 |
| 散热方式 | 自然冷却，无风扇 |
| 防护等级 | IP40 |
...
| 型号 | 描述 |
|-------|--------|
| ISE5006D-S-2GSFP-4GT-24 | 2 千兆光口 + 4 千兆电口工业级以太网交换机。2 × 1000Base-X SFP 光口 + 4 × 10/100/1000Base-T(X) 电口，SFP 接口（不含光模块）。IP40 防护等级，DIN 导轨式安装，工作温度 -40°C 至 +80°C。DC 12-52 V 电源输入，支持双电源冗余备份。 |
