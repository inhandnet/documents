...
**ISM5006D-S-W 专为工厂自动化、智能交通、视频监控及其他工业应用领域设计。**

ISM5006D-S-2GSFP-4GT-24-W-SFP 是 2 路千兆光口 + 4 路千兆电口的 WEB 网管工业以太网交换机，支持 4 个 10/100/1000Base-T(X) 电口和 2 个 1000Base-X 光口。光口可选 1x9 固定模块或 SFP 插槽，兼容千兆/百兆。产品符合 FCC、CE、RoHS 标准，支持工业现场所需的以太网二层协议，保证通信网络的稳定性。该系列交换机采用低功耗、无风扇设计，具有 -40℃ ~ +80℃ 的宽工作温度范围和良好的 EMC 电磁兼容性能，能适应恶劣工业环境，也可方便地安置在空间紧凑的控制箱中。导轨安装特性、宽温操作及 IP40 防护等级的金属外壳与 LED 指示灯，使 ISM5006D-S-W 成为一款可靠的工业级设备，为工厂自动化、智能交通、视频监控等应用组建快速稳定的网络终端接入提供安全可靠的解决方案。
...
- **全千兆接入：** 4 个千兆自适应电口 + 2 个千兆光口，光口可选 1x9 / SFP，兼容千兆/百兆。
...
| 端口 | 4 × 10/100/1000Base-T(X) 自适应 RJ45 端口 + 2 × 1000Base-X 光口（1x9 / SFP 可选） |
| 交换性能 | 20 Gbps 背板带宽，30 Mpps 包转发率，4K MAC |
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/dimension.png" width="100%" alt="ISM5006D-S-W 尺寸图" />
    <div style="width: 100%; text-align: center; font-size: 12px;">ISM5006D-S-W</div>
  </div>
...
| 光口 | 2 × 1000Base-X（1x9 / SFP 可选，兼容千兆/百兆） |
...
| 型号 | 描述 |
|-------|--------|
| ISM5006D-S-2GSFP-4GT-24-W-SFP | 2 千兆光口 + 4 千兆电口，SFP 接口（不含光模块）。IP40 防护等级，DIN 导轨式安装，工作温度 -40°C 至 +80°C。DC 12-52 V 电源输入，支持双电源冗余备份。 |
