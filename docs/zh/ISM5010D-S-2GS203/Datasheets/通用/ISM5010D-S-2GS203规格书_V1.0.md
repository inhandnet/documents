...
**ISM5010D-S-2GS203 专为工厂自动化、智能交通、视频监控及其他工业应用领域设计。**

ISM5010D-S-2GS203-8GT-SC-24 是网管型工业以太网交换机，产品符合 FCC、CE、RoHS 标准。支持 2 个千兆 SC 光口和 8 个千兆电口；支持工业现场所需的以太网二层协议，保证通信网络的稳定性。该系列交换机采用低功耗、无风扇设计，确保无噪声干扰，同时支持宽温工作和良好的 EMC 电磁兼容性能，保证在恶劣的工业环境中保持稳定的工作，为工厂自动化、智能交通、视频监控等工业应用领域组建快速稳定的网络终端接入网络提供安全可靠的解决方案。
...
- **全千兆接入：** 8 个千兆自适应电口 + 2 个千兆 SC 光口，光口千兆/百兆自适应。
...
|-----------|---------------|
| 类型 | 二层网管型工业以太网交换机 |
| 端口 | 2 × 1000Base-FX 光口（SC）+ 8 × 10/100/1000BaseT(X) 自适应RJ45端口 |
| 交换性能 | 38 Gbps 背板带宽，存储转发，8K MAC |
| 尺寸 / 重量 | 175.6 × 135 × 45.5 mm / 0.82 kg |
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/dimension.png" width="100%" alt="ISM5010D-S-2GS203 尺寸图" />
    <div style="width: 100%; text-align: center; font-size: 12px;">ISM5010D-S-2GS203</div>
  </div>
...
| 光纤端口 | 1000Base-FX 端口（SC 接口，千兆/百兆自适应） |
...
| 型号 | 描述 |
|-------|--------|
| ISM5010D-S-2GS203-8GT-SC-24 | 2 千兆 SC 光口 + 8 千兆自适应电口。IP40 防护等级，DIN 导轨式安装，DC 12-52 V 供电，工作温度 -40℃ 至 +85℃。 |
