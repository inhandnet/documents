<div style="width: 100%;height: 100%;background: url(images/ISM7010D-cover.jpg); background-size: 100% 100%;">
  <div style="height:75%;">
...
|-----------|---------------|
| 类型 | 二层网管型工业以太网交换机 |
| 端口 | 2 × 1000Base-X 光口（SFP）+ 8 × 10/100/1000BaseT(X) 自适应RJ45端口 + 1 × Console |
