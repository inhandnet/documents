...
**ISM7012D-S 专为工厂自动化、智能交通、视频监控及其他工业应用领域设计。**

ISM7012D-S-4GSFP-8GT-24 是 4 路千兆光口 + 8 路千兆电口的网管型工业以太网交换机，支持 8 个 10/100/1000Base-T(X) 电口和 4 个 1000Base-X SFP 光口。光口兼容千兆/百兆，并支持主板光口扩展 2.5G。产品符合 FCC、CE、RoHS 标准，支持工业现场所需的以太网二层协议及三层静态路由，保证通信网络的稳定性。该系列交换机采用低功耗、无风扇设计，具有 -40℃ ~ +85℃ 的宽工作温度范围和良好的 EMC 电磁兼容性能，能适应恶劣工业环境，也可方便地安置在空间紧凑的控制箱中。导轨安装特性、宽温操作及 IP40 防护等级的金属外壳与 LED 指示灯，使 ISM7012D-S 成为一款可靠的工业级设备，为工厂自动化、智能交通、视频监控等应用组建快速稳定的网络终端接入提供安全可靠的解决方案。
...
- **全千兆接入：** 8 个千兆自适应电口 + 4 个千兆 SFP 光口，光口兼容千兆/百兆，支持主板光口扩展 2.5G。
- **网络冗余：** 支持 STP/RSTP/MSTP 与工业环网协议 ERPS（自愈时间 < 20 ms），保障链路可靠性。
- **三层能力：** 支持静态路由与 VLAN 间互通，支持 GVRP 及 PTP/IEEE 1588v2 时钟同步。
- **便捷运维：** 支持 Web、CLI、SNMP v1/v2c/v3 管理，支持电源异常继电器告警（可选），平均无故障时间 300,000 小时。
...
|-----------|---------------|
| 类型 | 二层网管型工业以太网交换机 |
| 端口 | 8 × 10/100/1000Base-T(X) 自适应 RJ45 端口 + 4 × 1000Base-X SFP 光口 |
| 交换性能 | 56 Gbps 背板带宽，存储转发，8K MAC |
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/dimension.png" width="85%" alt="ISM7012D-S 尺寸图" />
    <div style="width: 85%; text-align: center; font-size: 12px;">ISM7012D-S</div>
  </div>
...
| 光口 | 4 × 1000Base-FX（SFP 接口，兼容千兆/百兆，支持主板光口扩展 2.5G） |
...
| 型号 | 描述 |
|-------|--------|
| ISM7012D-S-4GSFP-8GT-24 | 4 千兆光口 + 8 千兆自适应电口，SFP 接口。IP40 防护等级，DIN 导轨式安装，工作温度 -40°C 至 +85°C。DC 12-52 V 电源输入，支持双电源冗余备份。 |
