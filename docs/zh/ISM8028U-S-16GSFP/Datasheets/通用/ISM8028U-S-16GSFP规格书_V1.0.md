...
**ISM8028U-S 面向大型网络汇聚与中小型网络核心，提供万兆上行与高密度光纤接入。**

ISM8028U-S-8GC-4XGSFP-16GSFP-HV-HV 是一款万兆三层网管型工业交换机，配备 4 个万兆 SFP+ 光口、24 个千兆 SFP 光口和 8 个复用电口，具备先进的硬件处理能力和丰富的业务特性。产品支持 IPv4/IPv6 硬件双栈及线速转发，提供高容量交换能力，使客户能够从容应对 IPv6 时代的组网需求。ISM8028U-S 具有 -40℃ ~ +80℃ 的工作温度，坚固度强，能适应各种严苛环境，为用户的以太网设备联网提供可靠、便捷的解决方案。

**产品特点：**

- **丰富端口：** 4 × 万兆光口 + 24 × 千兆光口 + 8 × 复用电口，满足光纤汇聚与核心组网需求。
...
|-----------|---------------|
| 类型 | 三层网管型万兆工业交换机 |
| 端口 | 4 × 万兆光口（SFP+）+ 24 × 千兆光口（SFP）+ 8 × 复用千兆电口（RJ45） |
| 交换性能 | 1.2 Tbps 交换容量，406 Mpps 包转发率，598 Gbps 背板带宽，32K MAC |
| 尺寸 / 重量 | 442 × 325 × 44 mm（1U 机架）/ < 4 kg |
| 电源 | DC 36-72 V 或 AC/DC 110-240 V，冗余双电源，< 40 W |
| 环境 | 工作温度 -40 至 +80 ℃ |
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/dimension.png" width="90%" alt="ISM8028U-S 尺寸图" />
    <div style="width: 90%; text-align: center; font-size: 12px;">ISM8028U-S</div>
  </div>
...
| 管理端口 | 1 × Console 口 |
| 复位键 | 1 × 恢复出厂设置键 |
| 协商模式 | 电口 10/100/1000M 自协商；万兆光口支持 1G / 2.5G / 10G 多种速率模式；千兆光口兼容百兆 |
...
| 型号 | 描述 |
|-------|--------|
| ISM8028U-S-8GC-4XGSFP-16GSFP-HV-HV | 强三层网管 M 系列，4 × SFP+ 光口（支持千兆/万兆）+ 24 × 千兆光口 + 8 × 复用电口。19 英寸机架式安装，DC 36-72 V 与 AC/DC 110-240 V 冗余双电源输入，工作温度 -40℃ 至 +80℃。 |
