...
**ISM8028U-S 面向大型网络汇聚与中小型网络核心，提供万兆上行与完整三层能力。**

ISM8028U-S 是一款万兆三层网管型工业交换机，配备 4 个万兆 SFP+ 光口、24 个 10/100/1000M Base-T 自适应电口和 8 个复用光口，具备先进的硬件处理能力和丰富的业务特性。产品支持 IPv4/IPv6 硬件双栈及线速转发，提供高容量交换能力，使客户能够从容应对 IPv6 时代的组网需求。ISM8028U-S 具有 -40℃ ~ +80℃ 的工作温度，坚固度强，能适应各种严苛环境，为用户的以太网设备联网提供可靠、便捷的解决方案。
...
|-----------|---------------|
| 类型 | 三层网管型万兆工业交换机 |
| 端口 | 4 × 万兆光口（SFP+）+ 24 × 10/100/1000BaseT 自适应 RJ45 端口 + 8 × 复用千兆光口（SFP） |
...
| 型号 | 描述 |
|-------|--------|
| ISM8028U-S-8GC-4XGSFP-16GT-HV-HV | 强三层网管 M 系列，4 × SFP+ 光口（支持千兆/万兆）+ 24 × 电口 + 8 × 复用光口。19 英寸机架式安装，DC 36-72 V 与 AC/DC 110-240 V 冗余双电源输入，工作温度 -40℃ 至 +80℃。 |
