<div style="width: 100%;height: 100%;background: url(images/ISM8028U-cover.jpg); background-size: 100% 100%;">
  <div style="height:75%;">
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/dimension.png" width="95%" alt="ISM8028U 尺寸图" />
    <div style="width: 95%; text-align: center; font-size: 12px;">ISM8028U</div>
  </div>
