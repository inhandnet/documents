  ...
  <div style="position: relative; z-index: 1; height: 56%; padding-top: 160px; box-sizing: border-box;">
    ...
    <table style="margin: 56px auto 0 auto; border-collapse: separate; border-spacing: 12px; width: auto;">
      ...
      <tr>
        ...
        <td style="width: 200px; background-color: #4CAF50; color: #fff; padding: 8px 16px; border-radius: 16px; font-size: 16px; text-align: center; white-space: nowrap;">宽温</td>
      </tr>
    </table>
  </div>
...
**ISM8052U-S 面向大型网络汇聚与中小型网络核心，提供 48 口千兆接入与万兆上行。**

ISM8052U-S-4XGSFP-48GT-HV-HV 是一款万兆三层网管型工业交换机，配备 4 个万兆 SFP+ 光口和 48 个 10/100/1000M Base-T 自适应电口，具备先进的硬件处理能力和丰富的业务特性。产品支持 IPv4/IPv6 硬件双栈及线速转发，提供高容量交换能力，使客户能够从容应对 IPv6 时代的组网需求。ISM8052U-S 具有 -40℃ ~ +80℃ 的工作温度，坚固度强，能适应各种严苛环境，为用户的以太网设备联网提供可靠、便捷的解决方案。

**产品特点：**

- **丰富端口：** 4 × 万兆 SFP+ 光口 + 48 × 千兆电口，满足高密度接入与汇聚组网需求。
- **强大处理：** 基于 VCore-III MIPS 架构 CPU，4.8 Tbps 交换容量、1624 Mpps 包转发率。
- **宽温双电：** -40℃ ~ +80℃ 超宽工作温度；DC 36-72 V 与 AC/DC 110-240 V 冗余双电源输入。
...
|-----------|---------------|
| 类型 | 三层网管型万兆工业交换机 |
| 端口 | 4 × 万兆光口（SFP+）+ 48 × 10/100/1000Base-T 自适应 RJ45 端口 |
| 交换性能 | 4.8 Tbps 交换容量，1624 Mpps 包转发率，880 Gbps 背板带宽，64K MAC |
| 尺寸 / 重量 | 442 × 325 × 44 mm（1U 机架）/ < 5 kg |
| 电源 | DC 36-72 V 或 AC/DC 110-240 V，冗余双电源，< 60 W |
| 环境 | 工作温度 -40 至 +80 ℃ |
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/dimension.png" width="90%" alt="ISM8052U-S 尺寸图" />
    <div style="width: 90%; text-align: center; font-size: 12px;">ISM8052U-S</div>
  </div>
...
| 外壳 | 金属外壳 |
| 尺寸 (W × D × H) | 442 mm × 325 mm × 44 mm（含挂耳宽 483 mm，1U） |
| 重量 | < 5 kg |
| 安装方式 | 19 英寸机架式安装 |
| 散热方式 | 自然冷却，无风扇 |
| 存储温度 | -40 °C ~ +85 °C |
...
| 管理端口 | 1 × Console 口 |
| 复位键 | 1 × 恢复出厂设置键 |
| 协商模式 | 电口 10/100/1000M 自协商；光口支持 1G / 10G 速率模式 |
...
| 型号 | 描述 |
|-------|--------|
| ISM8052U-S-4XGSFP-48GT-HV-HV | 强三层网管 M 系列，4 × SFP+ 光口（支持千兆/万兆）+ 48 × 千兆电口。19 英寸机架式安装，DC 36-72 V 与 AC/DC 110-240 V 冗余双电源输入，工作温度 -40℃ 至 +80℃。 |
