...
**ISM8312D-S 面向大型网络汇聚与中小型网络核心，提供万兆上行、完整三层能力与 PoE 供电。**

ISM8312D-S-4XGSFP-8GT-48 是一款万兆三层网管型工业 PoE 交换机，配备 4 个万兆 SFP+ 光口和 8 个 10/100/1000M Base-T 自适应电口，1–8 口支持 IEEE 802.3af/at PoE，具备先进的硬件处理能力和丰富的业务特性。产品支持 IPv4/IPv6 硬件双栈及线速转发，提供高容量交换能力，使客户能够从容应对 IPv6 时代的组网需求。该系列交换机采用低功耗、无风扇设计，具有 -40℃ ~ +80℃ 的工作温度和良好的 EMC 电磁兼容性能，能适应恶劣工业环境。导轨式安装与宽温操作，使其成为一款可靠的工业级设备，为工厂自动化、智能交通、视频监控等应用组建快速稳定的网络终端接入提供安全可靠的解决方案。

**产品特点：**

- **丰富端口：** 4 × 万兆 SFP+ 光口 + 8 × 千兆电口（1–8 口支持 PoE），满足汇聚与核心组网及末端供电需求。
- **强大处理：** 基于 VCore-III MIPS 架构 CPU，1.2 Tbps 交换容量、406 Mpps 包转发率。
- **全千兆 PoE：** 8 个千兆自适应电口支持 IEEE 802.3af/at（单口最大 30 W）；DC 48-57 V 双电源冗余输入。
...
| 参数 | 规格 |
|-----------|---------------|
| 类型 | 三层网管型万兆工业 PoE 交换机 |
| 端口 | 4 × 万兆光口（SFP+）+ 8 × 10/100/1000Base-T 自适应 RJ45 端口（1–8 口支持 PoE） |
| 交换性能 | 1.2 Tbps 交换容量，406 Mpps 包转发率，8K MAC，56 Gbps 背板带宽 |
| 尺寸 / 重量 | 175.6 × 135 × 45.5 mm / < 0.75 kg |
| 电源 | DC 48-57 V，双电源冗余备份，< 18 W（不含 PoE 负载） |
| 环境 | 工作温度 -40 至 +80 ℃ |
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/dimension.png" width="100%" alt="ISM8312D-S 尺寸图" />
    <div style="width: 100%; text-align: center; font-size: 12px;">ISM8312D-S</div>
  </div>
...
| 电口 | 8 × RJ45 |
| RJ45 端口 | 10/100/1000Base-T 自动侦测，全/半双工，Auto-MDIX |
| 光口 | 4 × 万兆 SFP+（支持 1G / 2.5G / 10G 多种速率模式） |
...
| 输出功率 | 单端口最大 15.4 W（IEEE 802.3af） / 30 W（IEEE 802.3at） |
| <span style="color: green;">**硬件性能**</span> | |
| 交换容量 | 1.2 Tbps |
| 包转发率 | 406 Mpps |
| 背板带宽 | 56 Gbps |
| MAC 地址表 | 8K，支持自动更新与双向学习 |
| 包缓存区大小 | 4.1 Mbit |
...
| 型号 | 描述 |
|-------|--------|
| ISM8312D-S-4XGSFP-8GT-48 | 强三层网管 M 系列，4 × SFP+ 光口（支持千兆/万兆）+ 8 × 千兆电口，1–8 口支持 PoE。DIN 导轨式安装，DC 48-57 V 电源输入，支持双电源冗余备份，工作温度 -40℃ 至 +80℃。 |
