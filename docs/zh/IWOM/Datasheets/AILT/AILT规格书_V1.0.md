<div style="width: 100%;height: 100%;background: url(images/JYL-FF-C.jpg); background-size: 100% 100%;">
  <div style="height:75%;">
    <div style="width:35%; padding: 40px 40px">
      <img src="images/logo.png" alt="logo" />
    </div>
    <div style="font-size: 28px; font-weight: bold; color:#000;text-align: center; margin-bottom: 60px; transform: translateY(50px);">
      智慧配网，状态感知，为供电可靠性赋能
    </div>
  </div>
  <div style="padding-left: 40px;">
    <div style="font-size: 40px; font-weight: bold; color:#000;margin-bottom: 30px;">
     高精度暂态录波型故障指示器——采集单元(压簧固定型)
    </div>
    <div style="text-align: center;">
      <div style="display: flex; flex-wrap: wrap; gap: 16px; ">
        <div style="width: 200px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">高精度测量</div>
        <div style="width: 200px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">小电流自取电</div>
      </div>
      <div style="display: flex; flex-wrap: wrap; gap: 16px;margin-top:16px">
        <div style="width: 200px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">三相同步采集</div>
        <div style="width: 200px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px; ">带电安装免维护</div>
      </div>
    </div>
  </div>
</div>
...
### <span style="color: green;">故障研判与线路状态监测</span>
...
### <span style="color: green;">高可靠设计</span>

* 创新的高效取能技术，在电流低至**1A（基础版3A）** 的线路中可全功能运行
...
### <span style="color: green;">智能化检测线路故障，杜绝误动、拒动</span>
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 45%;">
    <img src="images/image-1.png" alt="产品尺寸图" />
    <div style="width: 100%; text-align: center; font-size: 12px;">尺寸（长x宽x高）：138mm x 140mm x 155mm</div>
  </div>
  <div style="width: 45%;">
...
<table style="width:100%; table-layout:fixed; font-size:11px;">
  ...
  <tr><td style="white-space: nowrap;">JYL-FF</td><td>C：采集单元</td><td>C：50Hz / 470-510MHz（中国）</td><td>A-1A取电/压簧固定<br/>L-3A取电/压簧固定<br/>M-1A取电/螺栓固定</td></tr>
</table>

**订购示例**：`JYL-IH-C-CA`
> 映翰通版采集单元，适用于50Hz、470MHz线路，1A取电，悬挂型取电方式。
