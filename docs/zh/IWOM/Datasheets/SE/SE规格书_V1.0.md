<div style="width: 100%;height: 100%;background: url(images/SESE.jpg); background-size: 100% 100%;">
  <div style="height:75%;">
    <div style="width:35%; padding: 40px 40px">
      <img src="images/logo.png" alt="logo" />
    </div>
    <div style="font-size: 28px; font-weight: bold; color:#000;text-align: center; margin-bottom: 60px; transform: translateY(85px);">
      智慧配网，状态感知，为供电可靠性赋能
    </div>
  </div>
  <div style="padding-left: 40px;">
    <div style="font-size: 40px; font-weight: bold; color:#000;margin-bottom: 30px;">
     高精度暂态录波型故障指示器——采集单元(太阳能取电型)
    </div>
...
<div style="text-align: center;">
  <img src="images/image-9.png" alt="解决方案拓扑" />
...
* 创新应用**太阳能取电**技术（**取电功率≥0.6W**），能够适用于**低负荷**或**间歇性负荷**线路，扩大应用范围
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 45%;">
    <img src="images/image-6.png" alt="产品尺寸图" />
    <div style="width: 100%; text-align: center; font-size: 12px;">尺寸（长x宽x高）：179x167mmx178mm(含丝杠为 254mm)</div>
  </div>
  <div style="width: 45%;">
...
<table style="width:100%; table-layout:fixed; font-size:11px;">
  ...
  <tr><td style="white-space: nowrap;">JYL-FF</td><td>C：采集单元</td><td>C：50Hz / 470-510MHz（中国）</td><td>S-太阳能取电/螺栓固定</td></tr>
</table>

**订购示例**：`JYL-IH-C-CS`
> 映翰通SE版采集单元，适用于50Hz、470MHz线路，太阳能取电/螺栓固定方式。
