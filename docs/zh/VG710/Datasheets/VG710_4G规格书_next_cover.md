...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between; row-gap: 16px;">
  <div style="width: 45%; flex-shrink: 0;">
    <img src="四图-4G/正视图.png" alt="正视图" style="width: 100%; max-height: 200px; object-fit: contain; display: block; margin: 0 auto;" />
    <div style="width: 100%; text-align: center; font-size: 12px;">正视图</div>
  </div>
  <div style="width: 45%; flex-shrink: 0;">
    <img src="四图-4G/侧视图.png" alt="侧视图" style="width: 100%; max-height: 200px; object-fit: contain; display: block; margin: 0 auto;" />
    <div style="width: 100%; text-align: center; font-size: 12px;">侧视图</div>
  </div>
  <div style="width: 45%; flex-shrink: 0;">
    <img src="四图-4G/接口图.png" alt="接口图" style="width: 100%; max-height: 240px; object-fit: contain; display: block; margin: 0 auto;" />
